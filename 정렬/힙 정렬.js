...
// 힙 생성 알고리즘의 시간복잡도 : 완전 이진 트리의 끝에 새로운 노드 1개가 추가되었을 때, 해당 노드가 최상위 노드까지 힙 생성 알고리즘으로 정렬되기 위해서는
//                               최대 총 logN개의 층(완전 이진 트리의 높이)에 대해 교환을 수행해야한다.
...
//                     모든 노드 중에서 가장 큰 값부터 작은 값까지 순서대로 꺼낼 수 있다. (최대 힙이 아닌 최소 힙으로 하면 작은값부터 꺼낼 수 있음)
